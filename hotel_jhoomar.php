...
<head>
    ...
    <title>Touristo | Hotel Jhoomer Baori</title>
...
<ul>
	...
	<section class="parallax-window" data-parallax="scroll" data-image-src="images/hotel/j1.jpg" data-natural-width="1400" data-natural-height="470">
		<div class="parallax-content-2">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<h1>Hotel Jhoomar Baori</h1>
						<span></span>
				...
				<div class="col-lg-8" id="single_tour_desc">
					...
					<div id="Img_carousel" class="slider-pro">
						<div class="sp-slides">
							...
							<div class="sp-slide">
								<img alt="Image" class="sp-image" src="images/hotel/j1.jpg" >
							</div>
                            <div class="sp-slide">
                                <img alt="Image" class="sp-image" src="images/hotel/j2.jpg" >
                            </div>
                            <div class="sp-slide">
                                <img alt="Image" class="sp-image" src="images/hotel/j3.jpg" >
                            </div>
                            <div class="sp-slide">
                                <img alt="Image" class="sp-image" src="images/hotel/j4.jpg" >
                            </div>
							
						</div>
						<div class="sp-thumbnails">
							<img alt="Image" class="sp-thumbnail" src="images/hotel/j1.jpg">
							<img alt="Image" class="sp-thumbnail" src="images/hotel/j2.jpg">
							<img alt="Image" class="sp-thumbnail" src="images/hotel/j3.jpg">
							<img alt="Image" class="sp-thumbnail" src="images/hotel/j4.jpg">
					...
					<div class="row">
						...
						<div class="col-lg-9">
							<h4>Hotel Jhoomar Baori</h4>
							<p>
								Castle Jhoomar Baori is located at the top of a hill nearest to the National Park. Once the summer Rest house of the Rulers of Jaipur, it was a real castle in the past and was converted in to a hotel by RTDC. It offers a scenic view of jungle and Aravali hills of Ranthmbore. The hotel provides comfort with security and hygiene. The restaurant serves Indian, continental cuisines and bar services variety of drinks.

Place To Visit : Ranthambore National Wildlife Park, Ranthambore Fort
							</p>
						 ...
						 <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Hotel</label>
                                    <input type="text"  name="hotel_name" value=" Hotel Jhoomar Baori" readonly="" >
                                </div>
                            </div>
