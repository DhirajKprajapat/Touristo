...
<head>
    ...
    <title>Touristo | Hotel-Vinayak</title>
...
<ul>
	...
	<section class="parallax-window" data-parallax="scroll" data-image-src="images/hotel/vinayak/v2.jpg" data-natural-width="1400" data-natural-height="470">
			...
			<div class="row">
				<div class="col-lg-8" id="single_tour_desc">
					<div id="single_tour_feat">
						<ul>
							<li><i class="icon_set_1_icon-4"></i>Hotel</li>
							<li><i class="icon_set_1_icon-83"></i>24 Hours</li>
							<li><i class="icon_set_1_icon-13"></i>Accessibiliy</li>
							<li><i class="icon_set_1_icon-82"></i>544 Likes</li>
					...
					<div id="Img_carousel" class="slider-pro">
						<div class="sp-slides">
							...
							<div class="sp-slide">
								<img alt="Image" class="sp-image" src="images/hotel/vinayak/v1.jpg" >
							</div>
                            <div class="sp-slide">
                                <img alt="Image" class="sp-image" src="images/hotel/vinayak/v2.jpg" >
                            </div>
                            <div class="sp-slide">
                                <img alt="Image" class="sp-image" src="images/hotel/vinayak/v3.jfif" >
                            </div>
                            <div class="sp-slide">
                                <img alt="Image" class="sp-image" src="images/hotel/vinayak/v5.jpg" >
                            </div>
							
						</div>
						<div class="sp-thumbnails">
							<img alt="Image" class="sp-thumbnail" src="images/hotel/vinayak/v1.jpg">
							<img alt="Image" class="sp-thumbnail" src="images/hotel/vinayak/v2.jpg">
							<img alt="Image" class="sp-thumbnail" src="images/hotel/vinayak/v3.jfif">
							<img alt="Image" class="sp-thumbnail" src="images/hotel/vinayak/v5.jpg">
					...
					<div class="row">
						...
						<div class="col-lg-9">
							<h4>Hotel Vinayak</h4>
							<p>
								The hotel is situated on Ranthambore Road heading to National Park. It is an ideal place for group and family stay. It offers AC rooms and Non AC rooms with modern amenities. Restaurant serves variety of cuisines and well stocked bar offers drinks including scotch, wine and beer. Hotel aims at providing safety, comfort and hygiene.

Place To Visit : Ranthambore Fort, National Wildlife Park Ranthambore

Around Sawai Madhopur : To check the increasing incursions of the Marathas, Madho Singh the ruler of jaipur requested the imperial emperor for the grant of the fort of Ranthambhour, but did not succeed. He therefore fortified Sherpur and named it Sawai Madhopur,in 1765 AD. In the same year the emperor assigned the fort of Ranthambhor to the Jaipur Raja. Therefore, the history of the region is a part of the history of the erstwhile Jaipur State.
							</p>
					...
					<div class="row">
						...
						<div class="col-lg-9">
							...
							<div class="review_strip_single">
								...
								<h4>Anonymous</h4>
								<p>
									"Execellent Looking Fort. I love this place."
								</p>
								<div class="rating">
									<i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile"></i><i class="icon-smile"></i>
								</div>
			...
			<aside class="col-lg-4">
					<form method="post" action="confirmation_hotel.php">
						 ...
						 <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Hotel</label>
                                    <input type="text"  name="hotel_name" value=" Hotel Vinayak" readonly="">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" placeholder="MobileNo" name="customer_mobile" required="">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="date-pick form-control" data-date-format="M d, D" type="text" name="check_in" required="">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label><i class="icon-calendar-7"></i> Check Out date</label>
                                    <input class="date-pick form-control" data-date-format="M d, D" type="text" name="check_out" required="">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                   ...
                                   <select name="room_type" required="">
                                        ...
                                        <option>Suit Room</option></select>
                                </div>
                            </div>
                        </div>
 ...
 <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" placeholder="No. of guest" name="guest" required="">
                                </div>
                            </div>
						...
						<button class="btn_full" name="submit">Book now</button>
						</form>
					</div>
					<!--/box_style_1 -->
