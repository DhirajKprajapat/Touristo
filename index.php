            ...
            <div class="col-lg-5 col-md-12 bg-img none-992 align-self-center">
                <div class="info">
                    ...
                    <div class="btn-section clearfix">
                        <a href="index.php" class="link-btn active btn-1 default-bg">Login</a>
                        <div class="clearfix"></div>
                        <a href="register.php" class="link-btn btn-1">Register</a>
                    </div>
                    ...
                    <div class="login-inner-form">
                      <form role="form" method="post" action="">
                            <div class="form-group form-box">
                                <input type="email" name="username" class="input-text" placeholder="Email Address" autocomplete="off" required="">
